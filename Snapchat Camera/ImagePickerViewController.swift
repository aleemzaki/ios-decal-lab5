...
class ImagePickerViewController: UIViewController, AVCapturePhotoCaptureDelegate {
    ...
    @IBAction func takePhoto(_ sender: UIButton) {
        ...
        if let squirrelImage = UIImage(named: "squirrel") {
            ...
            selectedImage = photoOutput.capturePhoto(with: AVCapturePhotoSettings(), delegate: <#T##AVCapturePhotoCaptureDelegate#>)
    ...
    func capture(_ captureOutput: AVCapturePhotoOutput, didFinishProcessingPhotoSampleBuffer photoSampleBuffer: CMSampleBuffer?, previewPhotoSampleBuffer: CMSampleBuffer?, resolvedSettings: AVCaptureResolvedPhotoSettings, bracketSettings: AVCaptureBracketedStillImageSettings?, error: Error?) {
        if let photoSampleBuffer = photoSampleBuffer {
            ...
            let photoData = AVCapturePhotoOutput.jpegPhotoDataRepresentation(forJPEGSampleBuffer: photoSampleBuffer, previewPhotoSampleBuffer: <#T##CMSampleBuffer?#>) {
